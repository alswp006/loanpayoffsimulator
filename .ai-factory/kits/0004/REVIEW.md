당신은 패킷 0004 ("Loans/Runs/RewardUnlocks Store Provider 구성 (hydrate + actions)")의 코드 리뷰를 수행합니다.
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/lib/store/loansStore.tsx
src/lib/store/runsStore.tsx
src/lib/store/rewardUnlocksStore.tsx
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0004 — Loans/Runs/RewardUnlocks Store Provider 구성 (hydrate + actions)
════════════════════════════════════════════════
