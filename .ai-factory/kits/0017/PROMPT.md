...
App.tsx에 모든 페이지(Home.tsx, LoanForm.tsx, Simulate.tsx, Result.tsx, Schedule.tsx, Settings.tsx) Route 연결, main.tsx 수정 금지(@AI:ANCHOR), 광고/결제 연동, 최종 UX 폴리시

## Acceptance Criteria
1. App.tsx에 모든 페이지 Route가 정의되어 있다
2. 모든 navigate() 대상에 Route가 존재한다
3. main.tsx의 TDSMobileAITProvider/BrowserRouter가 유지되어 있다
4. 앱이 '/' 경로에서 정상 렌더링된다
...
- Packet 0016: "전역 내비게이션(TabBar) + Safe-area 폴리시/UX 폴리시 마감" (files: src/components/MainTabBar.tsx, src/App.tsx)
