당신은 패킷 0006 ("단일 전략 요약 시뮬레이션(Snowball/Avalanche)")의 코드 리뷰를 수행합니다.
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/lib/simulation/simulateStrategySummary.ts
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0006 — 단일 전략 요약 시뮬레이션(Snowball/Avalanche)
════════════════════════════════════════════════
