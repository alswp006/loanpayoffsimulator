당신은 패킷 0014 ("S6 설정/도움말(/settings) 구현 (전략/입력 가이드 BottomSheet)")의 코드 리뷰를 수행합니다.
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/pages/Settings.tsx
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0014 — S6 설정/도움말(/settings) 구현 (전략/입력 가이드 BottomSheet)
════════════════════════════════════════════════
