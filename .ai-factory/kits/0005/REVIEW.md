당신은 패킷 0005 ("시뮬레이션 엔진 기반: 상수/이자 계산/오류 코드")의 코드 리뷰를 수행합니다.
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/lib/simulation/constants.ts
src/lib/simulation/interest.ts
src/lib/simulation/errorCodes.ts
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0005 — 시뮬레이션 엔진 기반: 상수/이자 계산/오류 코드
════════════════════════════════════════════════
